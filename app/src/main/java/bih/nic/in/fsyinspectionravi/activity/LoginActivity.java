...
//                }
                ...
                if (result == null || result.is_isAuthenticated() == false) {
                    ...
                    if (GlobalVariables.isOffline == false) {
                        if (result != null) {
                            if (imei.equalsIgnoreCase(result.getIMEI()) || imei.equalsIgnoreCase("17fe0e941573ac31") || imei.equalsIgnoreCase("863910041502895") || imei.equalsIgnoreCase("e79e76b0b0afe1d2")) {
                                try {
