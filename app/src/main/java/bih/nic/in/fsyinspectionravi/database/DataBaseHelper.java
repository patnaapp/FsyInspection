        ...
        try {
          ...
          // long d= db.delete("FarmerDetails", "User_ID=? and PanchayatCode=?", new String[]{userid.trim(),panchayatcode.trim()});
            ...
            for (FarmerDetails state : result) {
                ...
                ContentValues values = new ContentValues();
                values.put("cropAreaPaddyFarmer", state.getCropAreaPaddyFarmer());
                values.put("cropAreaPaddyShare", state.getCropAreaPaddyShare());
                values.put("cropAreaMazeeFarmer", state.getCropAreaMazeeFarmer());
                values.put("cropAreaMazeeShare", state.getCropAreaMazeeShare());
                values.put("cropAreaSoyabeenFarmer", state.getCropAreaSoyabeenFarmer());
                values.put("cropAreaSoyabeenShare", state.getCropAreaSoyabeenShare());
...
//                values.put("cropAreaWheat", state.getEt_fieldwheat());
//                values.put("cropAreaMazee", state.getEt_field_makka());
//                values.put("cropAreaChana", state.getEt_chana());
//                values.put("cropAreaMasoor", state.getEt_masoor());
//                values.put("cropAreaArhar", state.getEt_arhar());
//                values.put("cropAreaRai", state.getEt_raisarso());
//                values.put("cropAreaIkha", state.getEt_sugarcane());
//                values.put("cropAreaOnion", state.getEt_onion());
//                values.put("cropAreaPotato", state.getEt_potato());
                values.put("ConsumberNumberPresent", state.getISCOnsumbernumberExist());
                values.put("cropAreaPotato", state.getEt_potato());
                values.put("CropTypeKharif", state.getCropTypeKharif());
                values.put("CropTypeKharifName", state.getCropTypeKharifName());
                values.put("Soyabin", state.getSoyabin());
...
//                cur = db.rawQuery("Select * from RecordList where ApplicantId= '%" + searchstr + "%' and CurrentStatus = 'N'", null);
    ...
    public FarmerDetails setProgressData_all(Cursor cur) {
       ...
       // progress.setRashanCardNum(cur.getString(cur.getColumnIndex("RashanCardNumber")));
        progress.setEt_fieldwheat(cur.getString(cur.getColumnIndex("cropAreaWheat")));
        progress.setEt_field_makka(cur.getString(cur.getColumnIndex("cropAreaMazee")));
        progress.setEt_masoor(cur.getString(cur.getColumnIndex("cropAreaMasoor")));
        progress.setEt_arhar(cur.getString(cur.getColumnIndex("cropAreaArhar")));
        progress.setEt_sugarcane(cur.getString(cur.getColumnIndex("cropAreaIkha")));
        progress.setEt_potato(cur.getString(cur.getColumnIndex("cropAreaPotato")));
        progress.setEt_raisarso(cur.getString(cur.getColumnIndex("cropAreaRai")));
        progress.setEt_onion(cur.getString(cur.getColumnIndex("cropAreaOnion")));
        progress.setEt_chana(cur.getString(cur.getColumnIndex("cropAreaChana")));
        ...
        progress.setSoyabin(cur.getString(cur.getColumnIndex("Soyabin")));

        progress.setCropAreaPaddyFarmer(cur.getString(cur.getColumnIndex("cropAreaPaddyFarmer")));
        progress.setCropAreaPaddyShare(cur.getString(cur.getColumnIndex("cropAreaPaddyShare")));
        progress.setCropAreaMazeeFarmer(cur.getString(cur.getColumnIndex("cropAreaMazeeFarmer")));
        progress.setCropAreaMazeeShare(cur.getString(cur.getColumnIndex("cropAreaMazeeShare")));
        progress.setCropAreaSoyabeenFarmer(cur.getString(cur.getColumnIndex("cropAreaSoyabeenFarmer")));
        progress.setCropAreaSoyabeenShare(cur.getString(cur.getColumnIndex("cropAreaSoyabeenShare")));
    ...
    public List<FarmerDetails> getAllDataListCommunityData() {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery("Select * from InsertFarmer ", null);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                data.setSwaghosana_signer_name(cursor.getString(cursor.getColumnIndex("swaghosana_signer_name")));
                ...
                data.setCropAreaPaddyFarmer(cursor.getString(cursor.getColumnIndex("cropAreaPaddyFarmer")));
                data.setCropAreaMazeeFarmer(cursor.getString(cursor.getColumnIndex("cropAreaMazeeFarmer")));
                data.setCropAreaSoyabeenFarmer(cursor.getString(cursor.getColumnIndex("cropAreaSoyabeenFarmer")));
                data.setCropAreaPaddyShare(cursor.getString(cursor.getColumnIndex("cropAreaPaddyShare")));
                data.setCropAreaMazeeShare(cursor.getString(cursor.getColumnIndex("cropAreaMazeeShare")));
                data.setCropAreaSoyabeenShare(cursor.getString(cursor.getColumnIndex("cropAreaSoyabeenShare")));
